...
def opt_mintime(reftrack: np.ndarray,
    ...
    if pars["optim_opts"]["var_friction"] is not None:
        w_mue_fl, w_mue_fr, w_mue_rl, w_mue_rr, center_dist = approx_friction_map(reftrack=reftrack,
    ...
    # export data to CSVs
    export_mintime_solution(file_path=export_path,
                            pars=pars,
                            s=s_opt,
                            t=t_opt,
                            x=x_opt,
    ...
    if plot_debug:
        result_plots_mintime(pars=pars,
                             reftrack=reftrack,
                             s=s_opt,
                             t=t_opt,
                             x=x_opt,
